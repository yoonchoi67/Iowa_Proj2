...
def printFunction(med_freq_dict, med_category_freq_dict, individual_med_type_dict, individual_med_type_count_dict, individual_med_dict, individual_visit_count_dict):
    ...
    """ Question 6 answers print"""
    print("5. individual_visit_count_dict: ", individual_visit_count_dict[:10])
    print("\n")
